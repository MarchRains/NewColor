<template>
    <div style="overflow: hidden;position:absolute;top:0;width:100%;height:100%;background: white;z-index:1000;">
				...
				<div class="obet">
					<div class="selectbet">
						...
						<div class="numtext" style="display: block;!important;">
							统一金额<input maxlength="6" style="float: right;height: .3rem;width: 40%;line-height: .3rem;border: 0.01rem solid #ccc;border-radius: 0.04rem;background: #fff;margin: 0.05rem 0 0 .1rem;font-size: .14rem;text-indent: 0.05rem;" pattern="[0-9]*" :dataId="index"  class="gl-txt" id="settingAllAmount" type="tel"   placeholder="" value="">
						</div>
					</div>
					<!--注单列表-->
                        ...
                        <li v-for="(picktherendermin,index) in picktherender" :key="index">
                            ...
                            <div class="liright">
                                ...
                                <div class="detail">
                                    ...
                                    <!-- <input pattern="[0-9]*" :dataId="index" maxlength="6" id="" class="gl-txt" type="tel" :placeholder="picktherendermin.isdanzu" :value="Number(picktherendermin.isdanzuval).toFixed(2)"> -->
                                </div>
                                <div class="">
        ...
        <div v-if="!isid" ref="boty" style="position: relative;width:100%;bottom: 0.6rem;">
             <div class="wrap-addto"  style="bottom: -0.1rem;" >
					<div class="addto">
    ...
    export default{
        ...
        methods:{
            ...
            jsAll(){
                ...
                //     //console.log($this.picktherender[+$(this).attr('dataId')].isdanzuval)
            ...
            buyConfirm(){
                ...
                // if(oddsArrStr.indexOf("4.93")>-1){
                //     oddsArrStr=oddsArrStr.replace(/4.93/g,'4.94');
                // }
