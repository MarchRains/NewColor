<template>
    <div id="box" style="position:absolute;top:0;width:100%;height:100%;background: white;z-index:1000;overflow: hidden;overflow-x: hidden;">
		  <header class="header12222222222222" style=" position: fixed;"  :style="{'height':isLiuHai?'0.8rem':'0.5rem'}">
		  	<div class="color_species" :style="{'padding-top':isLiuHai?'0.45rem':'0rem'}">
		  		<a href="javascript:history.go(-1)"><p class="ps" v-show="iszstf" :style="{'top':isLiuHai?'0.54rem':'0.25rem'}"><i class="iconfont"></i></p></a>
		  		<span >{{cound}}</span>
		  ...
		  <main v-if="datacodea=='cqklsf'||datacodea=='gdklsf'" id="main"  style="position: relative;height:100%;margin-top: 0.8rem;padding-bottom:1rem;overflow: scroll;    overflow-x: hidden;" :style="{'margin-top':isLiuHai?'.85rem':'0.55rem'}">
			 <div style="padding:  0;" class="number_Kj"> 
			 </div>
			 <div style="font-size:16px;line-height: .2rem;color:red;padding: 10px 0;">
		  ...
		  <main v-else-if="datacodea=='xglhc'||datacodea=='fflhc'||datacodea=='jslhc'" id="main" style="position: relative;    height: 100%;padding-bottom:1rem;margin-top: .45rem;overflow: scroll;    overflow-x: hidden;" :style="{'margin-top':isLiuHai?'.85rem':'0.55rem'}">
			  <div style="padding:  0;" class="number_Kj"> 
			 </div>
			 <div style="font-size:16px;line-height: .2rem;color:red;padding: 10px 0;">
				 <span style="display: inline-block;width: 1rem;height: .28rem;line-height: .28rem;background-color: #ff6b52;color: white;border-radius: .05rem;">
		  ...
		  <main v-else-if="datacodea=='ssq'||datacodea=='jsssq'" id="main" style="position: relative;padding-bottom:0.35rem;height: 90%;margin-top: .45rem;overflow: scroll;    overflow-x: hidden;" :style="{'margin-top':isLiuHai?'.85rem':'0.55rem'}">
			 <div style="padding:  0;" class="number_Kj"> 
			 </div>
			 <div style="border-bottom: 2px solid red;font-size:16px;line-height: .2rem;color:red;padding: 10px 0;">
				 <span style="display: inline-block;width: 1rem;height: .28rem;line-height: .28rem;background-color: #ff6b52;color: white;border-radius: .05rem;">
					 走势
				 </span>
			 </div>
		  ...
		  <main v-else id="main" style="position: relative;    padding-bottom: .2rem;margin-top: 0.55rem;height: 100%;overflow: scroll;    overflow-x: hidden;" :style="{'margin-top':isLiuHai?'.85rem':'0.55rem'}">
			<div class="number_Kj"> 
	...
	export default{
		...
		trendchart(ids,w){
			...
			if(this.$store.state.isid){
				cvs.style.top = -55+'px';
			}else if(this.$store.state.isLiuhai){
				cvs.style.top = -60+'px';
			}else{
				cvs.style.top = -55+'px';
			}
