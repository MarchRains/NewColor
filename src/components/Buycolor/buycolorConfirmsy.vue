<template>
    <div style="overflow: hidden;position:absolute;top:0;width:100%;height:100%;background: white;z-index:1000;">
		...
		<div id="layout" class="" style="background-color: #f5f5f5;">
			<div class="header_wrap layoutid" :style="{'height':isLiuHai?'0.8rem':'0.5rem'}">
				<div class="header" :style="{'top':isLiuHai?'0.45rem':'0rem'}">
			...
			<!--主内容区-->
			<div class="ocontent" id="hkbetlistid" >
				<div class="timecount">
				...
				<div class="obet">
					<div class="selectbet">
						...
						<div class="numtext" style="display: block;!important;">
							统一金额
                            <input style="float: right;height: .3rem;width: 40%;line-height: .3rem;border: 0.01rem solid #ccc;border-radius: 0.04rem;background: #fff;margin: 0.05rem 0 0 .1rem;font-size: .14rem;text-indent: 0.05rem;" 
                            :dataId="index" maxlength="6" class="gl-txt" id="settingAllAmount"  pattern="\d" type="tel" placeholder="" value="" 
                            >
						</div>
					</div>
					<!--注单列表-->
         ...
         <div v-if="!isid" ref="boty" style="position: relative;width:100%;bottom: 0.6rem;">
             <div class="wrap-addto"  style="bottom: -0rem;" >
					<div class="addto">
...
<script>
    export default{
        ...
        created(){
            ...
            // console.log(this.$store.state.remove);
            ...
            if(!!window.localStorage.getItem('buycolorAll')){
                ...
                if(!!JSON.parse(window.localStorage.getItem('songshuj'))){
                    // console.log(window.localStorage.getItem('songshuj'));
                    for(var i = 0;i<JSON.parse(window.localStorage.getItem('songshuj')).length;i++){
        ...
        mounted:function(){
            ...
            this.$nextTick(()=>{
                // 内容的高度 = 页面的高度- 头部的高度
               document.getElementById("hkbetlistid").style.height=document.getElementsByTagName("body")[0].offsetHeight
               - document.getElementsByClassName("layoutid")[0].offsetHeight
             -30
             +"px"
             console.log(  document.getElementById("hkbetlistid").style.height)
            })
            // console.log(this.thisdatalist)
        },
        methods:{
            ...
            jsAll(){
                ...
                //     }
                //     // for(var i=0;i<$this.picktherender.length;i++){
                //     //        $this.picktherender[i].isdanzu=$this.er.toFixed(2)
                //     //          $this.picktherender[i].zonge=$this.er.toFixed(2)
