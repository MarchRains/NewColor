				...
				<div class="obet">
					<div class="selectbet">
						...
						<div class="numtext" style="display: block;!important;">
							统一金额<input style="float: right;height: .3rem;width: 40%;line-height: .3rem;border: 0.01rem solid #ccc;border-radius: 0.04rem;background: #fff;margin: 0.05rem 0 0 .1rem;font-size: .14rem;text-indent: 0.05rem;" pattern="[0-9]*" :dataId="index" maxlength="6" class="gl-txt" id="settingAllAmount" type="tel" placeholder="" value=""  onkeyup="value=value.replace(/[\W]/g,'')">
						</div>
					</div>
					<!--注单列表-->
