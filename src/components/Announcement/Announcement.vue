<template>
    <div  style="top:0;width:100%;;background: #f5f5f5;z-index:99;height:100%;display: flex;flex-direction: column;">
        <Header title="公告"></Header>
        <div class="gonggao" style="overflow: scroll;padding-bottom: 40px;">
			<div :style="{'margin-top':isLiuHai?'0.8rem':'0.5rem'}">
                <div v-for="particulars in notice" >
                    <p><img src="../../assets/source/imgs/laba.png" alt=""><span style="font-size:0.14rem;">{{particulars.title}}</span></p>
