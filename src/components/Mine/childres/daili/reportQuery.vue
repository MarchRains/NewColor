<template>
  <div  style="overflow: hidden;position:fixed;top:0;width:100%;height:100%;background: #f5f5f5;z-index:1000;    overflow: hidden;">
      <div class="index_header" style="">
        ...
        <div class="kined" style="overflow:scroll" :style="{'margin-top':isLiuHai?'0.3rem':'0'}">
     <div  style="width:100%;height:100%;background: #f5f5f5;z-index:1000;font-size: 0.14rem;">
        ...
        <div class="timefor clearFixed" style="color:#666" >
            ...
            <div style="color:#000;font-size:.14rem;">至</div>
            <div ref="endTime" @click="openPicker2"  >{{endDate}}</div>
            <div @click="changeTime">选择日期 <i 
    ...
    transform: rotate(135deg);"
       ...
       <div class="main">
           <ul class="mainuie">
               ...
               <li><span>实际盈亏</span><span>{{ Number(result.realPAL).toFixed(2)}}</span></li>
