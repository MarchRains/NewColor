...
<div style="top: 0;width: 100%;height:100%;background: #f5f5f5;">
   ...
   <div style=" position: relative;z-index: 1; top: 0;" ref="listwrapVue">
       <v-scroll :on-refresh="onRefresh" :on-infinite="onInfinite"> 
        <div class="content-wrap" :style="{'margin-top':isLiuHai?'0.3rem':'0'}" >
            <div class="que-list">
  ...
  export default{
        ...
        methods:{
			...
			getlistheight(){
				...
				var h = bodyheight - headerheight - document.getElementsByClassName("addquebtn")[0].offsetHeight + 'px';
				this.$refs.listwrapVue.style.height = h;
				if (this.$store.state.isid) {
					this.$refs.listwrapVue.style.top = '20px';
				}
