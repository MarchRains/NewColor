<template>
  <div ref="chargedetal" class="chargedetal" style="position:absolute;left:0;top:0;width:100%;height:100%;z-index:1000;overflow:hidden;">
      <headertop :title="title"  :datal="datal" :goDetal="mycollect"> </headertop>
        <div class="zhushou"  ref="zhuzhein" style="display:none" :style="{'margin-top':isLiuHai?'0.8rem':'0.5rem'}">
        ...
        <div style="height:100%;" >
            <div class="inputt" :style="{'margin-top':isLiuHai?'0.8rem':'0.5rem'}">
                <span >请输入充值金额</span>
            ...
            <div class="bott" style="position:absolute;bottom: 0rem;height:0.85rem;background:#f5f5f5;width: 100%;">
