    ...
    components: {
        ...
        methods:{
            styleCss(){
                ...
                let topH = $(".content").outerHeight(true) + $(".top").outerHeight(true);
                $(".details-wrap").css("top",topH)
                // document.getElementsByClassName("details-wrap")[0].style.height = document.getElementsByTagName("body")[0].clientHeight-225
                // +'px';
            },
            Copy() {
            ...
            buycolor(){
                var str = {
                        ...
                        this.$store.state.urlgoucai = $("#lotteryImg").attr("src");
