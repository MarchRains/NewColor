<template>
    <div  style="width:100%;height:100%;background:#f5f5f5; position: fixed;top: 0;z-index:1000;height:100%;buttom:0;right:0;left:0">
        <!-- 顶部 -->
        <headertop :title="title" > </headertop>
        <!-- 主内容区 -->
        <div class="content" :style="{'margin-top':isLiuHai?'0.8rem':'0.5rem'}">
