<template>
    <div style="position: fixed; top:0;left:0;bottom:0;right:0;height: 100%;overflow: hidden;background:#f1eeee;"> 
        <div  ref="mineFirst" id="mineFirst">
            ...
            <div class="usercontent" style="width:100%;">
                ...
                <div v-else class="details beforelogin" id="loginDiv">
                    ...
                    <div class="beforelogined" :style="{top: beforeloginedTop}">
                        <div class="details_left" >
                        ...
                        <div class="details_right">
                            ...
                            <p>
                                ...
                                <span id="userBalanceP" style="margin-left:0">¥{{balance | toFloor}}</span>
                                <span ><img  ref="iconfont1" @click="getmoney" src="../../assets/images/shuaxin.png" alt=""></span>
                            </p>
                        </div>
                         <div  @click="qiandaoo" class="qiandaoing" style="">
                           
                            <img style="height:0.4rem;border-radius: 50%;" src="../../assets/images/qiandaoed.png" title="" />
                            <!-- <span> {{qiandao}}</span> -->
                        </div>
                    </div>
                ...
                <!--tab切换-->
                <div class="tab" :style="{'top': tabTop}">
                    <div @click="chongzhi" class="tabcontent " id="rechargeFuncA">
                    <p><span><img src="../../assets/images/cun.png" alt=""></span> <span style="margin-top: 0.2rem;text-align:left;    border-right: 1px solid #c1c0c0;
    box-sizing: border-box;"> 充值</span></p>
                        <!-- <span>充值</span> -->
                    </div>
                    <div  class="tabcontent" id="drawingsA" @click="tabcontent">
                        <p><span><img  src="../../assets/images/qu.png" alt=""> </span><span style="margin-top: 0.2rem;text-align:left"> 提现</span></p>
                        <!-- <span>提现</span> -->
                    </div>
                </div>
                <div class="quarantine">
                ...
                <!--个人记录列表-->
                <div id="topmylist" style="position: absolute; width: 100%;background:#fff; left:0; right:0; bottom: .46rem;" :style="{top: topmylistTop}">
                   <div class="mylist" ref="mylist">
                    <ul style="padding-bottom: 0.2rem;">
                        ...
                        <li id="zhengqian"   @click="zhengqian">
                                <img v-if="type!=1" id="shared" src="../../assets/source/imgs/img-user/me_icon_fx.png" />
                                <img v-if="type==1" id="shared" src="../../assets/images/shared.png" />

                                <p v-if="type==1">邀请好友</p>
                                <p v-if="type!=1">分享赚钱</p>
                        </li>
            ...
            <div class="tixingg" >
                    ...
                    <div>
                       <img src="../../assets/images/tipd.png" style="width:0.9rem;" alt="">
                        <p style="margin-top:0.2rem;font-size:0.18rem;">陛下</p>
                        <p style="line-height:0.3rem;color:#000;font-size:0.16rem;">您还没有绑定银行卡</p>
                        <p style="line-height:0.4rem;color:#999;">请第一时间绑定银行卡</p>
                        <p style="line-height:0.4rem;line-height: 0.4rem;width: 60%; margin-left: 20%;background:#fa3956;border-radius: 20px;color:#fff"   @click="goseting">去设置</p>
                        <p style="line-height:0.4rem;line-height: 0.38rem;width: 60%; margin-left: 20%; border-radius: 20px;margin-top:0.1rem;" class="app_border"  @click="know">我知道了</p>
...
export default {
  ...
  computed: {
    ...
    beforeloginedTop() {
      return (this.$store.state.statusbarHeight + 20) / 100 + 'rem';
    },
    tabTop() {
      return (this.$store.state.statusbarHeight + 20 + 84) / 100 + 'rem';
    },
    topmylistTop() {
      return (this.$store.state.statusbarHeight + 20 + 84 + 60 + 5) / 100 + 'rem';
    }
  },
  updated() {
    this.account= JSON.parse(window.localStorage.getItem("currentUser")).account;//基础数据更新重新赋值用户名
  },
  created(){
    ...
    this.getOnlineRemark();
      ...
      this.currentUser = currentUsered;
  },

  mounted: function() {
    // 切换回来加载 获取代理类型 需要做登录判断
  ...
  methods: {
    ...
    topee(){
      ...
      this.account= this.currentUser.account;//用户名
	...
	getHeight() {
		...
		if (this.$store.state.isApp) {
			this.$refs.mylist.style.height =
				document.getElementsByTagName("body")[0].offsetHeight -12 -
				74 -
				70 -
				90 - 
				5+
		...
		*/
		// document.getElementById("topmylist").style.height =
		// 	document.getElementsByTagName("body")[0].offsetHeight -12 -
		// 	74 -
		// 	70 - 60 +"px";
