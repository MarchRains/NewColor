<template>
    ...
    <div style="height:100%;">
        ...
        <headertop :title="title" :leftType="leftType" :goLeftDetal="goLeftDetal" :leftText="leftText" :leftImg="leftImg" :rightText="rightText" :goRightDetal="init" />
        <div style="overflow:Scroll" id="loadmore">
            <mt-loadmore v-if="isApp" :top-method="loadTop" style="background:white;position: relative;z-index:10;" :style="{'top':isLiuHai?'0.8rem':'0.5rem'}"   ref="loadmore"  :max-distance="150" @top-status-change="handleTopChange">
                ...
                <div class="index_content">
                    <div class="broadcast">
                        ...
                        <div class="lotterylist">
                            <div class="lottery_title color" style="    margin-top: 0.05rem;">
                                <span>热门彩种</span>
                            </div>
                            ...
                            <ul class="list" id="moreListUl">
                                ...
                                <li id='lisd' style='width: 50%;float: left;height: 0.83rem;'>
                                    <a style='    width: 80%;height: 100%;float: left;margin-left: 10%;'>
                                        <div style='height: 0.9rem;float: left;'>
                                            <img id='imging'  style='width: 0.73rem;margin-top: 0.05rem' src='../../assets/images/more+_05.jpg' />
                                        </div>
                                        <div style='float: left;font-size: 0.14rem;'>
                                            <h3 style='line-height: 0.83rem;margin-left:0.1rem;'>更多</h3>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                                        ...
                                        <div class="windiv" ref="windiv" style="top:0">
                                            <ul id="winListUl" ref="winListUl">
                                                <li v-for="(item5,index) in list5" :key="index">
                                                    <span><img style="width:0.2rem;margin-top:0.13rem;" src="../../assets/source/imgs/jbs.png" alt=""> {{item5.user.account.substring(0, 3) + "****"}}</span>
         ...
         <mt-loadmore v-if="!isApp" :top-method="loadTop"  style="background:white;position: relative;z-index:10;"  ref="loadmore"  :max-distance="150" @top-status-change="handleTopChange">
            <!-- <p slot="top" class="mint-loadmore-top" style="font-size:0.16rem">
                <img  class="rotate1" :class="{ 'rotate': topStatus === 'pull' }" ref="pp" src="../../statics/images/jtou.png" style="position:absolute;left:0.1rem;width:20px;bottom:0.15rem;" alt="">
                <span class="imgdown" style=" position:absolute;left:0.1rem;width:0.2rem;height:0.2rem;bottom:0.15rem;" ref="imgdown" ></span>
                <span style="position:absolute;right:0.1rem">最后更新：{{nowdata}}</span>
        ...
        <div class="home-tankuang" v-if="storetankuang && popWin.pop" ref="homenoc" style="height:100%;" :class="{'none':none}">
            ...
            <div style="margin: 0 auto;" class="aaa"  ref="noticil">
                <div id="quni" style="font-size:0.16rem; position: relative;background:#fff; border-radius: 10px 10px 0px 0px;" >
                    ...
                    <span style="margin-top:0.1rem" v-if="iftet"  v-html="tankuangims.text"></span>
                </div>
        ...
        <div class="xiazai" ref="xiazai" v-if="xiazaishow" id="homexia">
            ...
            <p style="margin-bottom:0.05rem;"> 
                <span @click="xiaoshi"> <i><img style="width:0.2rem;" src="../../assets/images/xx.png" alt=""></i> </span>
                <span style="color:#fff" >下载 APP 体验更多购彩乐趣</span><a  target="_blank" class="app_color" @click="xiazaii">下载app</a>
            </p>
        </div>
...
<script>
    ...
    import { isAndroid } from '../../assets/api/app.js'
    export default {
        components: {
            headertop
        },
        ...
        methods:{
            ...
            gettitle(){
                ...
                if( localStorage.getItem("token")){
                    this.leftType = 3,
                    this.leftText = "<img src='../../assets/source/imgs/images/logo_03.png'/>";
                    this.rightText = "我的收藏";
                    this.islog=false;
                }else{
                    this.leftType = 1;
            ...
            scroll(time) {
               ...
               scrollte(time) { 
                ...
                this.timeoutt=setInterval(()=>{
                    ...
                    if(a>windivwidth){
                       windivwidth=this.$refs.scrollSpan.offsetWidth/2;
                       a=0
                    }
                },time)
            },
        ...
        mounted:function() {
            ...
            //判断如果是清除缓存进来的 跳转到登录页面
            if(window.localStorage.getItem('clearItems')){
                window.localStorage.removeItem("clearItems")
                setTimeout(() => {
...
.block{
    ...
    .section1 ul li:nth-child(2) img{
        margin-top:0.05rem;
    }
    .section1 ul li p{
       font-size: 0.13rem;
    ...
    .lotterylist .list li:nth-child(odd) {
        border-right: 0.01rem solid whitesmoke;
    }
    .lotterylist li a {
            // width: 90%;
    // margin-left: 10%;
