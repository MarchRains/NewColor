...
<div id="app" style="overflow: hidden;">
  ...
  <div style="height:100%;overflow:hidden;position:relative;width:100%;" >
		...
		<div class="content_zhuanzhang tianjiayinhangka" :style="{'margin-top':isLiuHai?'0.8rem':'0.5rem'}">
			...
			<div class="first-one" id="select" >
				...
				<!-- <input type="hidden"> -->
                <span  id="showBank" :name='bankListIndex'  class="sk_yh_2" @click="shangshen" style="text-align:left;color:#666;line-height:0.36rem">{{yinhang}}</span>
...
export default {
  ...
  mounted() {
    ...
    // this.onValuesChange()
    //console.log(this.$store.state.item+1111111111);
    ...
    addBankCard() {
      ...
      if (!localUser.userCardList || localUser.userCardList.length <= 0) {
        ...
        if (result && result.code == 200) {
          ...
          //console.log(this.$store.state.item+222222222222);
