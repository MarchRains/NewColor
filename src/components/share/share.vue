<template>
  <div  style="overflow: hidden;position:fixed;top:0;width:100%;height:100%;background: #fff;z-index:1000;">
      <div class="index_header" style="">
        ...
        <p class="maintop"  :style="{'margin-top':isLiuHai?'0.8rem':'0.5rem','margin-bottom':money?'-0.6rem':'0'}">
      ...
      <div class="main">
          ...
          <ul>
              <li> 
              <span>邀请码</span>
                  <input class="usernameipt" maxlength="6" :value="modata" type="tel" placeholder="6位数字组合" style="font-size:0.14rem;">
              <span style="" @click="mode">
                <span class="zingd" >随机选码</span> </span></li>
              <li> <span>彩票返点</span><input type="button"  :value="localRebate"  style="padding-left:0;background: transparent;text-align:left;font-size:0.15rem;" class="jin"><span class="jin" ><span></span > </span></li>
          </ul>
          <p ref="pp" style="font-size:0.14rem;line-height:0.3rem;height:0.3rem;color:red;position: absolute;width: 100%;">{{pp}}</p>
          <div class="robate" > 
              <ul>
     ...
     <div class="tixing" ref="stt">
                <div>
                    <p >复制链接分享:</p>
                    <p ref="nuim" style="margin-bottom: 0.2rem;">{{url}}</p>
...
.maintop {
  ...
  background: #fff;
  font-size: 0.14rem;
  border-bottom: 0.05rem solid rgb(245, 245, 245);
  span {
    float: left;
    width: 50%;
    line-height: 0.45rem;
