<template>
 <div >
     <div  style="width:100%;height:100%;background: #f5f5f5;z-index:1000;font-size: 0.14rem;">
        ...
        <div class="timefor clearFixed"    :style="{'margin-top':isLiuHai?'0.8rem':'0.5rem'}">
        ...
        <div class="moneyDetail clearFixed">
            ...
            <div class='bfcBox'>
                <div class="bfcLayout">
                    <img src="../../assets/images/count2.png" style="    height: 0.34rem;
    width: 0.34rem;" alt="" class="picMoney">
                </div>
                <div class="bfcLayout">
                    <p>投注金额</p>
        ...
        <div ref="ploxyStatistics"  style="overflow:scroll;background-color: #fff;">
    ...
    getHeight() {
     ...
     var path=this.$route.path.split("/")
        if(path[path.length-1]=='share'){
           this.$refs.ploxyStatistics.style.height =document.getElementsByTagName("body")[0].offsetHeight -45  -45 -45 -45 -78 -40 -10
           + "px";
        }else{
            this.$refs.ploxyStatistics.style.height =document.getElementsByTagName("body")[0].offsetHeight -50  -45 -45 -88 -40 + "px";
        }
