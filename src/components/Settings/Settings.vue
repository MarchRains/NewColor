<template>
    <div style="position:absolute;top:0;width:100%">
        ...
        <!-- 游戏目录tab -->
        <div class="game_wrap" :style="{'margin-top':isLiuHai?'0.8rem':'0.5rem'}" >
        ...
        <div class="gamerulelist" >
            ...
            <ul class="list" style="height: 594px;" ref="listwrapVue">
                <li v-for="(sortAll,index) in sort" :key="index">
                    <div class="gamedata" v-for="(rebateAll,index) in rebate[sortAll.id]" :key="index">
                        ...
                        <span>{{sortAll.noteMaxAmount}}.00</span>
                        <span>{{sortAll.itemMaxAmount}}.00</span>
                    </div>
                </li>
            </ul>
        </div>
