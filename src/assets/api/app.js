...
function geturlIos(urlStr) {
	...
	window.webkit.messageHandlers.jumpSatWithURLString.postMessage(urlStr)
}
function geturlAnd(urlStr) {
	// $.tips("hahah")
	...
	javascript: js2android.jumpCustomerService(urlStr);

}

export function JumpOpen(urlStr) {
	if (isAndroid()) {
